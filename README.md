...
python render_smpl.py --dataroot ../data/Synthetic/<data_set> --obj_path ../data/Synthetic/<data_set>/person_0/smplx
```

- This should now generate a folder called `smpl_pos` under data/Synthetic/<data_set>

3. Generate reconstructions and visualization
```
# go back to project root folder
 python apps/eval_3d.py --config configs/<config> --folder <folder_of_experiment>
```

- Now the reconstructions should be in the folder specified in the flag
